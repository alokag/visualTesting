...
eyes.setBatch("Visual AI Test", "Tester: Alok");
async function inputCreds(){
    await browser.setValue('#username', 'valid@user.com');
    await browser.setValue('#password','test1234');
}
//test 1 -> use of check points to test the log in page ui.
//test 2 -> log in functionality
// test 3 -> table sort
//test 4 -> Canvas
...
describe('Applitools Visual Test', async ()=> {
    ...
    describe('Login Page functionality', async () => {
        ...
        it('should not log in, you dont enter the username and password and click the login button', async () => {
            try {
